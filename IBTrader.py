...
loggerName = 'IBTrader-'+str(datetime.now().year)+str(datetime.now().month)+str(datetime.now().day)
...
class IBTrader():
    ...
    def connect(self, clientId=255, host="localhost", port=31505):
        """ Establish connection to IB Gateway on Quantal Test Server """
    ...
    def createStockContract(self, symbol, currency="USD", exchange="SMART"):
        ...
        return contract
    def createFXCFDContract(self, symbol, currency, exchange="SMART"):
